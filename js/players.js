...
export const PLAYER_ROLES = {
    ...
    // Add lowercase aliases to match HTML data attributes
    artist: { 
        alias: 'ARTIST',
        get name() { return PLAYER_ROLES.ARTIST.name; },
        get description() { return PLAYER_ROLES.ARTIST.description; },
        get startingResources() { return PLAYER_ROLES.ARTIST.startingResources; },
        get opposingRole() { return PLAYER_ROLES.ARTIST.opposingRole; },
        get abilityIdentifier() { return PLAYER_ROLES.ARTIST.abilityIdentifier; },
        get token() { return PLAYER_ROLES.ARTIST.token; },
        get abilityDescription() { return PLAYER_ROLES.ARTIST.abilityDescription; },
        get activeAbilityDescription() { return PLAYER_ROLES.ARTIST.activeAbilityDescription; }
    },
    historian: {
        alias: 'HISTORIAN',
        get name() { return PLAYER_ROLES.HISTORIAN.name; },
        get description() { return PLAYER_ROLES.HISTORIAN.description; },
        get startingResources() { return PLAYER_ROLES.HISTORIAN.startingResources; },
        get opposingRole() { return PLAYER_ROLES.HISTORIAN.opposingRole; },
        get abilityIdentifier() { return PLAYER_ROLES.HISTORIAN.abilityIdentifier; },
        get token() { return PLAYER_ROLES.HISTORIAN.token; },
        get abilityDescription() { return PLAYER_ROLES.HISTORIAN.abilityDescription; },
        get activeAbilityDescription() { return PLAYER_ROLES.HISTORIAN.activeAbilityDescription; }
    },
    revolutionary: {
        alias: 'REVOLUTIONARY',
        get name() { return PLAYER_ROLES.REVOLUTIONARY.name; },
        get description() { return PLAYER_ROLES.REVOLUTIONARY.description; },
        get startingResources() { return PLAYER_ROLES.REVOLUTIONARY.startingResources; },
        get opposingRole() { return PLAYER_ROLES.REVOLUTIONARY.opposingRole; },
        get abilityIdentifier() { return PLAYER_ROLES.REVOLUTIONARY.abilityIdentifier; },
        get token() { return PLAYER_ROLES.REVOLUTIONARY.token; },
        get abilityDescription() { return PLAYER_ROLES.REVOLUTIONARY.abilityDescription; },
        get activeAbilityDescription() { return PLAYER_ROLES.REVOLUTIONARY.activeAbilityDescription; }
    },
    colonialist: {
        alias: 'COLONIALIST',
        get name() { return PLAYER_ROLES.COLONIALIST.name; },
        get description() { return PLAYER_ROLES.COLONIALIST.description; },
        get startingResources() { return PLAYER_ROLES.COLONIALIST.startingResources; },
        get opposingRole() { return PLAYER_ROLES.COLONIALIST.opposingRole; },
        get abilityIdentifier() { return PLAYER_ROLES.COLONIALIST.abilityIdentifier; },
        get token() { return PLAYER_ROLES.COLONIALIST.token; },
        get abilityDescription() { return PLAYER_ROLES.COLONIALIST.abilityDescription; },
        get activeAbilityDescription() { return PLAYER_ROLES.COLONIALIST.activeAbilityDescription; }
    },
    politician: {
        alias: 'POLITICIAN',
        get name() { return PLAYER_ROLES.POLITICIAN.name; },
        get description() { return PLAYER_ROLES.POLITICIAN.description; },
        get startingResources() { return PLAYER_ROLES.POLITICIAN.startingResources; },
        get opposingRole() { return PLAYER_ROLES.POLITICIAN.opposingRole; },
        get abilityIdentifier() { return PLAYER_ROLES.POLITICIAN.abilityIdentifier; },
        get token() { return PLAYER_ROLES.POLITICIAN.token; },
        get abilityDescription() { return PLAYER_ROLES.POLITICIAN.abilityDescription; },
        get activeAbilityDescription() { return PLAYER_ROLES.POLITICIAN.activeAbilityDescription; }
    },
    entrepreneur: {
        alias: 'ENTREPRENEUR',
        get name() { return PLAYER_ROLES.ENTREPRENEUR.name; },
        get description() { return PLAYER_ROLES.ENTREPRENEUR.description; },
        get startingResources() { return PLAYER_ROLES.ENTREPRENEUR.startingResources; },
        get opposingRole() { return PLAYER_ROLES.ENTREPRENEUR.opposingRole; },
        get abilityIdentifier() { return PLAYER_ROLES.ENTREPRENEUR.abilityIdentifier; },
        get token() { return PLAYER_ROLES.ENTREPRENEUR.token; },
        get abilityDescription() { return PLAYER_ROLES.ENTREPRENEUR.abilityDescription; },
        get activeAbilityDescription() { return PLAYER_ROLES.ENTREPRENEUR.activeAbilityDescription; }
    }
};
...
export const createPlayer = (name, role, isHuman = false) => {
    // Normalize role to uppercase to match PLAYER_ROLES keys
    const normalizedRole = role.toUpperCase();
    
    if (!PLAYER_ROLES[normalizedRole]) {
    ...
    const player = {
        ...
        currentCoords: { ...startCoords }, // Add currentCoords for board.js compatibility
        resources: { ...PLAYER_ROLES[normalizedRole].startingResources },
        finished: false,
